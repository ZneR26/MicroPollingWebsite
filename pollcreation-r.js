...
document.getElementById("createOption3").addEventListener("keyup", characterCounter);
document.getElementById("createOption4").addEventListener("keyup", characterCounter);
document.getElementById("createOption5").addEventListener("keyup", characterCounter);